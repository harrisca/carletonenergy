...
public class DataFragment extends Fragment {
    ...
    private static String increment = "quarterhour"; //must be quarter-hour for day; hour for week; day for month/year
    private static Calendar startTime;
    private static Calendar endTime;
    private static String graphTitle = "Energy Data";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup rg, int checkedId) {
                ...
                /* TODO: somehow make this restart!!!!!! It works when rotated back, but nothing happens
                 if the page doesn't reload*/

                //onCreateView(inflater, container, savedInstanceState);
                //Fragment fragment = getFragmentManager().findFragmentById(R.layout.fragment_data);
        ...
        Log.i("radioButtonTest", plot.toString());

        Log.i("nullpointer?", "startTime: " + startTime);
        Log.i("nullpointer?", "dataSource: " + dataSource);
        Log.i("nullpointer?", "endTime: " + endTime);
        ...
        */
        ...
        if (increment.equals("quarterhour")) {
            ...
            Log.i("radioButtonTest", plot.getTitle());
        }
